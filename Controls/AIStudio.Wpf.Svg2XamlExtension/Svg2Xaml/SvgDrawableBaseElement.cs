...
namespace Svg2Xaml
{
      ...
      : SvgBaseElement
    {
          ...
          : base(document, parent, drawableBaseElement)
        {
            ...
            //注入wpf颜色，AIStudio扩展
            if (document.Options != null && !string.IsNullOrEmpty(document.Options.Fill))
                Fill = SvgPaint.Parse(document.Options.Fill);
            ...
            //注入wpf颜色，AIStudio扩展
            if (document.Options != null && !string.IsNullOrEmpty(document.Options.Stroke))
                Stroke = SvgPaint.Parse(document.Options.Stroke);
