        ...
        public static SvgPaint Parse(string value)
        {
            ...
            if (value.StartsWith("#"))
            {
                ...
                if (color.Length == 8)
                {
                    ...
                    byte r = Byte.Parse(color.Substring(2, 2), NumberStyles.HexNumber);
                    byte g = Byte.Parse(color.Substring(4, 2), NumberStyles.HexNumber);
                    byte b = Byte.Parse(color.Substring(6, 2), NumberStyles.HexNumber);
                    return new SvgColorPaint(new SvgColor(r, g, b, a));
                }
            }
